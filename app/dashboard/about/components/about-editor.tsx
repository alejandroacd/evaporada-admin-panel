...
import { RichTextEditor } from "@/app/dashboard/publications/components/RichTextEditor";
...
export default function AboutEditor({ initialData }: AboutEditorProps) {
  ...
  const defaultData: AboutData = {
    id: null,
    title: "About Us",
    content: "<h1>Welcome to Our Story</h1><p>Tell your story here...</p>",
    updated_at: null
  };
  ...
  useEffect(() => {
    if (initialData && Object.keys(initialData).length > 0) {
      // Solo actualizar si initialData tiene contenido real
      setFormData(prev => ({
        ...prev,
        ...initialData,
  ...
  const handleSave = async () => {
    ...
    if (!contentToSave.trim() || contentToSave.trim() === "<p></p>" || contentToSave.trim() === "<p><br></p>") {
    ...
    startTransition(async () => {
      try {
        ...
        if (result.success) {
          toast.success(result.message || "About page saved successfully!");
          setIsEditing(false);
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div 
                      ...
                      dangerouslySetInnerHTML={{ __html: renderHTML(formData.content || "") }}
                    />
                  </div>
                </CardContent>
              </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-3 text-sm">
              <ul className="space-y-2 text-gray-600">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-gray-400">•</span>
                  <span>Add links to reference external content</span>
                </li>
              </ul>
            </CardContent>
          </Card>
